...
const Body = () => {
    return (
      <div>
        <div class="grid max-w-6xl grid-cols-1 mx-auto mt-4 lg:grid-cols-7 font-display">
          <div class="w-full h-full col-span-full lg:col-span-4 lg:pr-8">
            ...
            <div class="flex mt-8 space-x-4">
              <a
                href="/#"
                class="px-4 py-3 font-semibold text-white transition duraction-200 transform rounded-sm shadow-sm bg-gray-700 hover:bg-gray-600"
              >
                Ver Imagenes
              </a>
            </div>
        ...
        <div
          class="grid max-w-6xl grid-cols-3 mx-auto mt-16 font-display"
          id="Servicios"
        >
          <div class="col-span-1 lg:pr-8">
            <h4 class="font-semibold tracking-tight text-gray-500 uppercasetext-md">
              DESING
            </h4>
            ...
            <a
              ...
              class="mt-8 inline-block px-5 py-3 font-semibold text-white transition duraction-200 transform rounded-sm shadow-sm bg-gray-700 hover:bg-gray-600"
            >
              Learn more
            </a>
          </div>
          ...
          <div class="col-span-2">
            <iframe
              width="760"
              height="512"
              src="https://www.youtube.com/watch?v=hME4LGA1p1c"
        ...
        <div
          class="grid max-w-6xl grid-cols-1 mx-auto mt-1 lg:grid-cols-7 font-display"
          id="Imagenes"
        >
          <div class="w-full h-full col-span-full lg:col-span-4 lg:pr-8">
        ...
        <div
          class="grid max-w-6xl grid-cols-1 mx-auto mt-8 lg:grid-cols-7 font-display"
          id="Imagenes"
        >
          <div class="w-full h-full col-span-full lg:col-span-4 lg:pr-8">
            <div class="max-w-lg mx-auto col-span-full lg:col-span-3 lg:pr-8">
